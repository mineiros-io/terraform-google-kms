...
- **`keys`**: _(Optional `list(keys)`)_
  ...
  Each `keys` object accepts the following fields:
...
- **`key_algorithm`**: _(Optional `string`)_
...
- **`key_protection_level`**: _(Optional `string`)_
