header {
  ...
  url   = "https://mineiros.io/?ref=terraform-google-kms"

  badge "build" {
    image = "https://github.com/mineiros-io/terraform-google-kms/workflows/Tests/badge.svg"
    url   = "https://github.com/mineiros-io/terraform-google-kms/actions"
    text  = "Build Status"
  }

  badge "semver" {
    image = "https://img.shields.io/github/v/tag/mineiros-io/terraform-google-kms.svg?label=latest&sort=semver"
    url   = "https://github.com/mineiros-io/terraform-google-kms/releases"
...
references {
  ref "homepage" {
    value = "https://mineiros.io/?ref=terraform-google-kms"
  }
  ref "hello@mineiros.io" {
    value = "mailto:hello@mineiros.io"
  }
  ref "badge-build" {
    value = "https://github.com/mineiros-io/terraform-google-kms/workflows/Tests/badge.svg"
  }
  ref "badge-semver" {
    value = "https://img.shields.io/github/v/tag/mineiros-io/terraform-google-kms.svg?label=latest&sort=semver"
  }
  ref "badge-license" {
  ...
  ref "build-status" {
    value = "https://github.com/mineiros-io/terraform-google-kms/actions"
  }
  ref "releases-github" {
    value = "https://github.com/mineiros-io/terraform-google-kms/releases"
  }
  ...
  ref "variables.tf" {
    value = "https://github.com/mineiros-io/terraform-google-kms/blob/main/variables.tf"
  }
  ref "examples/" {
    value = "https://github.com/mineiros-io/terraform-google-kms/blob/main/examples"
  }
  ref "issues" {
    value = "https://github.com/mineiros-io/terraform-google-kms/issues"
  }
  ref "license" {
    value = "https://github.com/mineiros-io/terraform-google-kms/blob/main/LICENSE"
  }
  ref "makefile" {
    value = "https://github.com/mineiros-io/terraform-google-kms/blob/main/Makefile"
  }
  ref "pull requests" {
    value = "https://github.com/mineiros-io/terraform-google-kms/pulls"
  }
  ref "contribution guidelines" {
    value = "https://github.com/mineiros-io/terraform-google-kms/blob/main/CONTRIBUTING.md"
  }
}
